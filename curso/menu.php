<nav class="modulos">
    ...
    <div class="modulo vermelho">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=sessao&file=gerir_sessao">
                    Gerir Sessão
                </a>
            </li>           
        </ul>
    ...
    <div class="modulo azul-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=poo&file=data">
                    Classe Data
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="exercicio.php?dir=poo&file=visibilidade">
                    Visibilidade
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=poo&file=static">
                    Membros Estáticos
                </a>
            </li>
            <li>
